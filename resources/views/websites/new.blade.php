        ...
        <form action="{{ route('websites.new') }}" method="post" enctype="multipart/form-data" id="form-website">
                    ...
                    <div class="col-12 col-lg-4 px-2">
                        <div class="form-group mb-0">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="email" value="1" class="custom-control-input {{ $errors->has('email') ? ' is-invalid' : '' }}" id="i-email" @if(old('email')) checked @endif @cannot('emailReports', ['App\Models\User']) disabled @endcannot>
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="checkbox" name="exclude_bots" value="1" class="custom-control-input {{ $errors->has('exclude_bots') ? ' is-invalid' : '' }}" id="i-exclude-bots" @if(old('exclude_bots') || old('exclude_bots') == null) checked @endif>
